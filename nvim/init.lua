...
vim.keymap.set('n', '<Leader>zB', function() require('dap').set_breakpoint() end)
vim.keymap.set('n', '<Leader>zp', function() require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: ')) end)
vim.keymap.set('n', '<Leader>zr', function() require('dap').repl.open() end)
vim.keymap.set('n', '<Leader>zl', function() require('dap').run_last() end)
